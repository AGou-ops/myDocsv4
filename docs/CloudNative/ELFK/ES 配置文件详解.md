...
# ※额外注意： es6.x中，对应的配置项为：discovery.zen.ping.unicast.hosts: ["192.168.81.210", "192.168.81.220","192.168.81.70"]，如果改节点为master，则需要填写整个es集群的所有IP地址或者主机名称，如果节点为node，仅需要填写master节点的IP以及当前节点的IP地址即可。
